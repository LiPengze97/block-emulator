...
type TestCrossTxRate_Pyramid struct {
	epochID       int
	totTxNum      []float64
...
func NewTestCrossTxRate_Pyramid() *TestCrossTxRate_Pyramid {
	return &TestCrossTxRate_Pyramid{
		epochID:       -1,
...
func (tctr *TestCrossTxRate_Pyramid) OutputMetricName() string {
	return "CrossTransaction_ratio"
}

func (tctr *TestCrossTxRate_Pyramid) UpdateMeasureRecord(b *message.BlockInfoMsg) {
	...
	tctr.totTxNum[epochid] += float64(b.ParamidTxNum) / 2
}

func (tctr *TestCrossTxRate_Pyramid) HandleExtraMessage([]byte) {}

func (tctr *TestCrossTxRate_Pyramid) OutputRecord() (perEpochCTXratio []float64, totCTXratio float64) {
